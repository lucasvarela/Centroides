...
%		\centering
%		\includegraphics[width=.7\linewidth]{./im/1_10}
%		\label{fcN4}
%	\end{minipage}%
%	\begin{minipage}{.4\textwidth}
%		\centering
%		\includegraphics[width=.9\linewidth]{./im/100_1}
%		\label{fcN5}
%	\end{minipage}
%\end{figure}
%
...
%	\begin{minipage}{.5\textwidth}
%		\centering
%		\includegraphics[width=.7\linewidth]{./im/1}
%		\label{fcN4}
%	\end{minipage}%
%	\begin{minipage}{.4\textwidth}
%		\centering
%		\includegraphics[width=.9\linewidth]{./im/100_10}
%		\label{fcN5}
%	\end{minipage}
%\end{figure}
%
